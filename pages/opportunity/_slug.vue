            ...
            <div class="container">
                <div class="opportunity-header__content w-full flex justify-between gap-16">
                    ...
                    <div class="opportunity-header__img">
                        <nuxt-img provider="cloudinary" :src="`companies/${comp.img}`" class="shadow-xl rounded-xl" />
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="container">
                <h2 class="heading-secondary text-center">
                    In this video, I'll show you how {{ comp.title }} <br />
                ...
                <div class="flex flex-col lg:flex-row gap-8">
                    ...
                    />
                    <div class="mx-auto">
                        <p class="font-bold">Watch the vide on the left. Here is my contact information</p>

                        <p>Tim Bell</p>
                        <p>Bell Web Agency</p>
                        <a class="block" href="mailto.info@bellwebagency.com">info@bellwebagency.com</a>
                        <a class="block" href="tel:8645310429">864-531-0429</a>
                        <a
                            href="https://bellwebagency.hbportal.co/schedule/608330e0ca6881002a936dee"
                            class="btn block"
                            target="_blank"
                            ><span class="text-5xl">Yes, Let's Talk About this</span><br />Click to Schedule a 15 Minute
                            Call on My Calendar</a
                        >
                    </div>
                </div>
            </div>
...
export default {
    ...
    async asyncData({ $content, params, error }) {
        const comp = await $content('opportunity', params.slug).fetch().catch()
